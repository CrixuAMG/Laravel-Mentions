# How to Contribute
* You have found a bug ? You can open an [issue](https://github.com/CrixuAMG/Laravel-Mentions/issues/new). (For a security issue, please send me a mail : [here](mailto:zoro.fmt@gmail.com)) :
